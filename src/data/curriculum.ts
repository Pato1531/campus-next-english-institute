...
export const curriculum: CursoCurriculum[] = [
  ...
  },
  {
    ...
    titulo: "Job Ready English",
    nivel: "A2-B1",
    modulos: [
      {
        id: "jobready-m1",
        titulo: "Módulo 1 · Getting Ready",
        orden: 1,
        lecciones: [
          {
            id: "jobready-m1-l1",
            titulo: "Talking About Yourself",
            videoUrl: "https://youtu.be/jlhoz7ZngGE",
            pdfUrl: "https://krohueieztaedatyobwb.supabase.co/storage/v1/object/public/Lecciones/JRE_M1L1_Material_Estudio.pdf",
            orden: 1,
            // Sin "preguntas": este curso usa ejercicios de práctica abiertos,
            // no mini test de opción múltiple. Se completa con el botón manual.
          },
          {
            id: "jobready-m1-l2",
            titulo: "Your CV and Work Experience",
            videoUrl: "https://youtu.be/9AYCoHUe294",
            pdfUrl: "https://krohueieztaedatyobwb.supabase.co/storage/v1/object/public/Lecciones/JRE_M1L2_Material_Estudio.pdf",
            orden: 2,
            // Sin "preguntas": este curso usa ejercicios de práctica abiertos,
            // no mini test de opción múltiple. Se completa con el botón manual.
          },
          {
            id: "jobready-m1-l3",
            titulo: "Common Interview Questions",
            videoUrl: "https://youtu.be/cpQnh_8uMKI",
            pdfUrl: "https://krohueieztaedatyobwb.supabase.co/storage/v1/object/public/Lecciones/JRE_M1L3_Material_Estudio.pdf",
            orden: 3,
            // Sin "preguntas": este curso usa ejercicios de práctica abiertos,
            // no mini test de opción múltiple. Se completa con el botón manual.
          },
          {
            id: "jobready-m1-l4",
            titulo: "Company Research and Questions to Ask",
            videoUrl: "https://youtu.be/4k9mnqlN_tM",
            pdfUrl: "https://krohueieztaedatyobwb.supabase.co/storage/v1/object/public/Lecciones/JRE_M1L4_Material_Estudio.pdf",
            orden: 4,
            // Sin "preguntas": este curso usa ejercicios de práctica abiertos,
            // no mini test de opción múltiple. Se completa con el botón manual.
          },
      ...
      {
        id: "jobready-m2",
        titulo: "Módulo 2 · In the Interview and Closing",
        orden: 2,
        lecciones: [
          {
            id: "jobready-m2-l1",
            titulo: "Strengths and Weaknesses - Metodo STAR",
            videoUrl: "https://youtu.be/QqiPO2dbgqA",
            pdfUrl: "https://krohueieztaedatyobwb.supabase.co/storage/v1/object/public/Lecciones/JRE_M2L1_Material_Estudio.pdf",
            orden: 1,
            // Sin "preguntas": este curso usa ejercicios de práctica abiertos,
            // no mini test de opción múltiple. Se completa con el botón manual.
          },
          {
            id: "jobready-m2-l2",
            titulo: "Talking About Salary",
            videoUrl: "https://youtu.be/rJE4gQt6nw4",
            pdfUrl: "https://krohueieztaedatyobwb.supabase.co/storage/v1/object/public/Lecciones/JRE_M2L2_Material_Estudio.pdf",
            orden: 2,
            // Sin "preguntas": este curso usa ejercicios de práctica abiertos,
            // no mini test de opción múltiple. Se completa con el botón manual.
          },
          {
            id: "jobready-m2-l3",
            titulo: "Difficult Questions and Employment Gaps",
            videoUrl: "https://youtu.be/eQLryMYn-xc",
            pdfUrl: "https://krohueieztaedatyobwb.supabase.co/storage/v1/object/public/Lecciones/JRE_M2L3_Material_Estudio.pdf",
            orden: 3,
            // Sin "preguntas": este curso usa ejercicios de práctica abiertos,
            // no mini test de opción múltiple. Se completa con el botón manual.
          },
          {
            id: "jobready-m2-l4",
            titulo: "Closing the Interview and Next Steps",
            videoUrl: "https://youtu.be/PiF-3LMK7uA",
            pdfUrl: "https://krohueieztaedatyobwb.supabase.co/storage/v1/object/public/Lecciones/JRE_M2L4_Material_Estudio.pdf",
            orden: 4,
            // Sin "preguntas": este curso usa ejercicios de práctica abiertos,
            // no mini test de opción múltiple. Se completa con el botón manual.
          },
